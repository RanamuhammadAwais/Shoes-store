  ...
  <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        ...
        Discover unparalleled craftsmanship with our bespoke leather shoes, tailored to perfection for the discerning gentleman.
        </p>
    ...
    <p className="text-xs text-gray-500">&copy; 2025. RMA. All rights reserved.</p>
  </div>
</footer>
